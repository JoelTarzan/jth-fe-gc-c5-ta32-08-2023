...
public class ListarCientificos extends JFrame {
	 ...
	 * Create the frame.
	 */
	public ListarCientificos(ArrayList<String> registros) {
		...
		JLabel lblTitle = new JLabel("Lista de Científicos");
		lblTitle.setBounds(172, 11, 124, 14);
